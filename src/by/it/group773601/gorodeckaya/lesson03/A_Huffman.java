package by.it.group773601.gorodeckaya.lesson03;
...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
       ...
       for (Map.Entry<Character,Integer> i: count.entrySet()) {
           priorityQueue.add(new LeafNode(i.getValue(),i.getKey()));
       }
        ...
        while (true){
            if(priorityQueue.size()!=1) {
                Node newLeaf1 = priorityQueue.remove();
                Node newLeaf2 = priorityQueue.remove();
                InternalNode parent = new InternalNode(newLeaf1, newLeaf2);
                ...
                InternalNode EndInteralNode = (InternalNode) priorityQueue.remove();
                EndInteralNode.fillCodes("");
                for(int i=0; i< s.length(); i++){
