package by.it.group773601.gorodeckaya.lesson05;
...
public class C_QSortOptimized {
    ...
    void quickSort(Segment[] mas, int left, int right){
        ...
        if (lm > left) quickSort(mas, left, --lm);
        if (rm < right) quickSort(mas, ++rm, right);
    }
