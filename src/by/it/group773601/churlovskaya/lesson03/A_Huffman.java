package by.it.group773601.churlovskaya.lesson03;
...
public class A_Huffman {
    ...
    String encode(File file) throws FileNotFoundException {
        ...
        for (Map.Entry<Character, Integer> el: count.entrySet()) {
            priorityQueue.add(new LeafNode(el.getValue(), el.getKey()));
        }
        ...
        int fullSize = 2 * priorityQueue.size() - 1;
        for (; size < fullSize; size++) {
        ...
        //.....
        String code = "";
        priorityQueue.peek().fillCodes(code);
        for (int i = 0; i < s.length(); i++) {
