package by.it.group773602.vasilevich.lesson04;
...
public class B_MergeSort {
    ...
    int[] getMergeSort(InputStream stream) throws FileNotFoundException {
        ...
        int middle = length/2;
        a = merge(mergeSort(a, 0, middle), mergeSort(a, middle + 1, length - 1) );*/
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        InputStream stream = new FileInputStream(root + "by/it/group773602/vasilevich/lesson04/dataB.txt");
