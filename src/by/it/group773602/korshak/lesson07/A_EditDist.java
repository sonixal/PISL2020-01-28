package by.it.group773602.korshak.lesson07;
...
public class A_EditDist {
    ...
    private int distance(String first, String second, final int i, final int j) {
        if (i == 0) return j;
        if (j == 0) return i;
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        InputStream stream = new FileInputStream(root + "by/it/group773602/korshak/lesson07/dataABC.txt");
