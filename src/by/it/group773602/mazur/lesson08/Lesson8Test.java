...
public class Lesson8Test {
    ...
    public void A() throws Exception {
        ...
        InputStream stream = new FileInputStream(root + "by/it/group773602/mazur/lesson08/dataA.txt");
    ...
    public void B() throws Exception {
        String root = System.getProperty("user.dir") + "/src/";
        InputStream stream = new FileInputStream(root + "by/it/group773602/mazur/lesson08/dataB.txt");
