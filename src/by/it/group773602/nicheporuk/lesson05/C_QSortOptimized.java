package by.it.group773602.nicheporuk.lesson05;
...
public class C_QSortOptimized {
    ...
    private class Segment  implements Comparable{
        ...
        public int compareTo(Object o) {
            ...
            return Integer.compare(this.start, ((C_QSortOptimized.Segment)o).start);
        }
    }
    void qSort(C_QSortOptimized.Segment[] mas, int left, int right){
        int midInd = (left + right) / 2;
        C_QSortOptimized.Segment mid = mas[midInd];
    ...
    void swap(C_QSortOptimized.Segment[] mas, int l, int r){
        C_QSortOptimized.Segment tmp = mas[l];
        mas[l] = mas[r];
        mas[r] = tmp;
    }
    ...
    int[] getAccessory2(InputStream stream) throws FileNotFoundException {
        ...
        C_QSortOptimized.Segment[] segments=new C_QSortOptimized.Segment[n];
        //число точек
