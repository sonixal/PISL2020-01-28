package by.it.group773602.gritskevich.lesson05;
...
public class A_QSort {
    ...
    private class Segment  implements Comparable{
        ...
        public int compareTo(Object o) {
            ...
            int tmp = Integer.compare(this.start, ((Segment)o).start);
            if (tmp != 0){
                return tmp;
            }
    ...
    void qSort(Segment[] mas, int left, int right){
        ...
        Segment tmp;
        while (l <= r) {
            while (mid.compareTo(mas[l]) > 0) {
                l++;
            }

            while (mid.compareTo(mas[r]) < 0) {
                r--;
            }
            if (l > r){
                break;
    ...
    public static void main(String[] args) throws FileNotFoundException {
        ...
        InputStream stream = new FileInputStream(root + "by/it/group773602/gritskevic/lesson05/dataA.txt");
